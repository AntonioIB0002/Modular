...
declare const props: ("linear" | "step" | "dir" | "id" | "orientation" | "ids" | "onStepChange" | "onStepComplete" | "count" | "getRootNode")[];
declare const splitProps: <Props extends Partial<UserDefinedContext>>(props: Props) => [Partial<UserDefinedContext>, Omit<Props, "linear" | "step" | "dir" | "id" | "orientation" | "ids" | "onStepChange" | "onStepComplete" | "count" | "getRootNode">];
