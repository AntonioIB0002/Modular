...
var alert = (0, import_dev4.defineSlotRecipe)({
  className: "alert",
...
var avatar = (0, import_dev5.defineSlotRecipe)({
  className: "avatar",
...
var badge = (0, import_dev6.defineRecipe)({
  className: "badge",
  base: {
    alignItems: "center",
    borderRadius: "full",
...
var button = (0, import_dev7.defineRecipe)({
  className: "button",
...
var card = (0, import_dev8.defineSlotRecipe)({
  className: "card",
...
var clipboard = (0, import_dev11.defineSlotRecipe)({
  className: "clipboard",
...
var code = (0, import_dev12.defineRecipe)({
  className: "code",
  base: {
    alignItems: "center",
    bg: "bg.subtle",
...
var collapsible = (0, import_dev13.defineSlotRecipe)({
...
var colorPicker = (0, import_dev14.defineSlotRecipe)({
...
var combobox = (0, import_dev15.defineSlotRecipe)({
  className: "combobox",
...
var datePicker = (0, import_dev16.defineSlotRecipe)({
...
var dialog = (0, import_dev17.defineSlotRecipe)({
  className: "dialog",
...
var drawer = (0, import_dev18.defineSlotRecipe)({
  className: "drawer",
  slots: [...anatomy.keys()],
  base: {
    backdrop: {
...
var editable = (0, import_dev19.defineSlotRecipe)({
  className: "editable",
...
var field = (0, import_dev20.defineSlotRecipe)({
  className: "field",
...
var fieldset = (0, import_dev21.defineSlotRecipe)({
  className: "fieldset",
...
var fileUpload = (0, import_dev22.defineSlotRecipe)({
...
var formLabel = (0, import_dev23.defineRecipe)({
  className: "formLabel",
  base: {
    color: "fg.default",
    fontWeight: "medium"
...
var hoverCard = (0, import_dev24.defineSlotRecipe)({
  className: "hoverCard",
...
var icon = (0, import_dev25.defineRecipe)({
  className: "icon",
  base: {
    color: "currentcolor",
...
var input = (0, import_dev26.defineRecipe)({
  className: "input",
...
var kbd = (0, import_dev27.defineRecipe)({
  className: "kbd",
  base: {
    alignItems: "center",
    bg: "bg.subtle",
...
var link = (0, import_dev28.defineRecipe)({
  className: "link",
  base: {
    alignItems: "center",
    color: "fg.default",
...
var menu = (0, import_dev29.defineSlotRecipe)({
  className: "menu",
...
var import_anatomy18 = require("@ark-ui/anatomy");
...
var numberInput = (0, import_dev30.defineSlotRecipe)({
  className: "numberInput",
  slots: import_anatomy18.numberInputAnatomy.keys(),
  base: {
    root: {
      colorPalette: "accent",
      display: "flex",
...
var import_anatomy19 = require("@ark-ui/anatomy");
var import_dev31 = require("@pandacss/dev");
var pagination = (0, import_dev31.defineSlotRecipe)({
  className: "pagination",
  slots: import_anatomy19.paginationAnatomy.keys(),
  base: {
    root: {
      display: "flex",
      gap: "2.5"
...
var import_anatomy20 = require("@ark-ui/anatomy");
var import_dev32 = require("@pandacss/dev");
var pinInput = (0, import_dev32.defineSlotRecipe)({
  className: "pinInput",
  slots: import_anatomy20.pinInputAnatomy.keys(),
  base: {
    root: {
      display: "flex",
      flexDirection: "column",
...
var import_anatomy21 = require("@ark-ui/anatomy");
var import_dev33 = require("@pandacss/dev");
var popover = (0, import_dev33.defineSlotRecipe)({
  className: "popover",
  slots: import_anatomy21.popoverAnatomy.keys(),
  base: {
    positioner: {
      position: "relative"
    },
...
var import_anatomy22 = require("@ark-ui/anatomy");
var import_dev34 = require("@pandacss/dev");
var progress = (0, import_dev34.defineSlotRecipe)({
  className: "progress",
  slots: import_anatomy22.progressAnatomy.keys(),
  base: {
    root: {
      alignItems: "center",
      colorPalette: "accent",
...
var import_anatomy23 = require("@ark-ui/anatomy");
var import_dev35 = require("@pandacss/dev");
var qrCode = (0, import_dev35.defineSlotRecipe)({
  className: "qrCode",
  slots: import_anatomy23.qrCodeAnatomy.keys(),
  base: {}
});

// src/theme/recipes/radio-button-group.ts
var import_anatomy24 = require("@ark-ui/anatomy");
var import_dev36 = require("@pandacss/dev");
var radioButtonGroup = (0, import_dev36.defineSlotRecipe)({
  className: "radioButtonGroup",
  slots: import_anatomy24.radioGroupAnatomy.keys(),
  base: {
    root: {
      colorPalette: "accent",
      display: "flex",
...
var import_anatomy25 = require("@ark-ui/anatomy");
var import_dev37 = require("@pandacss/dev");
var radioGroup = (0, import_dev37.defineSlotRecipe)({
  className: "radioGroup",
  slots: import_anatomy25.radioGroupAnatomy.keys(),
  base: {
    root: {
      colorPalette: "accent",
      display: "flex",
...
var import_anatomy26 = require("@ark-ui/anatomy");
var import_dev38 = require("@pandacss/dev");
var ratingGroup = (0, import_dev38.defineSlotRecipe)({
  className: "ratingGroup",
  slots: import_anatomy26.ratingGroupAnatomy.keys(),
  base: {
    root: {
      colorPalette: "accent",
      display: "flex",
...
var import_anatomy27 = require("@ark-ui/anatomy");
var import_dev39 = require("@pandacss/dev");
var segmentGroup = (0, import_dev39.defineSlotRecipe)({
  className: "segmentGroup",
  slots: import_anatomy27.segmentGroupAnatomy.keys(),
  base: {
    root: {
      alignItems: "flex-start",
      colorPalette: "accent",
...
var import_anatomy28 = require("@ark-ui/anatomy");
var import_dev40 = require("@pandacss/dev");
var select = (0, import_dev40.defineSlotRecipe)({
  className: "select",
...
var import_anatomy29 = require("@ark-ui/anatomy");
var import_dev41 = require("@pandacss/dev");
var signaturePad = (0, import_dev41.defineSlotRecipe)({
  className: "signaturePad",
  slots: import_anatomy29.signaturePadAnatomy.keys(),
  base: {}
});

// src/theme/recipes/skeleton.ts
var import_dev42 = require("@pandacss/dev");
var skeleton = (0, import_dev42.defineRecipe)({
  className: "skeleton",
  base: {
...
var import_anatomy30 = require("@ark-ui/anatomy");
var import_dev43 = require("@pandacss/dev");
var slider = (0, import_dev43.defineSlotRecipe)({
  className: "slider",
  slots: import_anatomy30.sliderAnatomy.keys(),
  base: {
    root: {
      colorPalette: "accent",
      display: "flex",
...
var spinner = (0, import_dev44.defineRecipe)({
  className: "spinner",
  base: {
    colorPalette: "accent",
    display: "inline-block",
...
var import_anatomy31 = require("@ark-ui/anatomy");
var import_dev45 = require("@pandacss/dev");
var splitter = (0, import_dev45.defineSlotRecipe)({
  className: "splitter",
  slots: import_anatomy31.splitterAnatomy.keys(),
  base: {
    root: {
      display: "flex",
      gap: "2"
...
var import_anatomy32 = require("@ark-ui/anatomy");
var import_dev46 = require("@pandacss/dev");
var switchRecipe = (0, import_dev46.defineSlotRecipe)({
  className: "switchRecipe",
  jsx: ["Switch", /Switch\.+/],
  slots: import_anatomy32.switchAnatomy.keys(),
  base: {
    root: {
      alignItems: "center",
      colorPalette: "accent",
...
var table = (0, import_dev47.defineSlotRecipe)({
  className: "table",
...
var import_anatomy33 = require("@ark-ui/anatomy");
var import_dev48 = require("@pandacss/dev");
var tabs = (0, import_dev48.defineSlotRecipe)({
  className: "tabs",
  slots: import_anatomy33.tabsAnatomy.keys(),
  base: {
    root: {
      colorPalette: "accent",
      display: "flex",
...
var import_anatomy34 = require("@ark-ui/anatomy");
var import_dev49 = require("@pandacss/dev");
var tagsInput = (0, import_dev49.defineSlotRecipe)({
  className: "tagsInput",
  slots: import_anatomy34.tagsInputAnatomy.keys(),
  base: {
    root: {
      colorPalette: "accent",
      display: "flex",
...
var text = (0, import_dev50.defineRecipe)({
  className: "text",
  jsx: ["Heading", "Text"],
  variants: {
    variant: {
...
var textarea = (0, import_dev51.defineRecipe)({
  className: "textarea",
...
var import_anatomy35 = require("@ark-ui/anatomy");
var import_dev52 = require("@pandacss/dev");
var toast = (0, import_dev52.defineSlotRecipe)({
  className: "toast",
  slots: import_anatomy35.toastAnatomy.keys(),
  base: {
    root: {
      background: "bg.default",
      borderRadius: "l3",
...
var import_anatomy36 = require("@ark-ui/anatomy");
var import_dev53 = require("@pandacss/dev");
var toggleGroup = (0, import_dev53.defineSlotRecipe)({
  className: "toggleGroup",
  slots: import_anatomy36.toggleGroupAnatomy.keys(),
  base: {
    root: {
      display: "flex",
      overflow: "hidden",
...
var import_anatomy37 = require("@ark-ui/anatomy");
var import_dev54 = require("@pandacss/dev");
var tooltip = (0, import_dev54.defineSlotRecipe)({
  className: "tooltip",
  slots: import_anatomy37.tooltipAnatomy.keys(),
  base: {
    content: {
      background: "gray.a12",
      borderRadius: "l2",
...
var import_anatomy38 = require("@ark-ui/anatomy");
var import_dev55 = require("@pandacss/dev");
var treeView = (0, import_dev55.defineSlotRecipe)({
  className: "treeView",
  slots: import_anatomy38.treeViewAnatomy.keys(),
  base: {
    root: {
      width: "full"
    },
...
var createRadiiTokens = (borderRadius) => {
  return import_dev56.defineSemanticTokens.radii(
    (0, import_ts_pattern.match)(borderRadius).with("none", () => ({
      l1: { value: "{radii.none}" },
      l2: { value: "{radii.none}" },
      l3: { value: "{radii.none}" }
    })).with("xs", () => ({
...
var shadows = import_dev57.defineSemanticTokens.shadows({
  xs: {
    value: {
...
var createSemanticTokens = (options) => {
  ...
  return (0, import_dev58.defineSemanticTokens)({
    colors: {
      ...extraColors,
...
var textStyles = (0, import_dev59.defineTextStyles)({
...
var animations = import_dev60.defineTokens.animations({
  "backdrop-in": {
...
var blurs = import_dev61.defineTokens.blurs({
  sm: { value: "4px" },
  base: { value: "8px" },
  md: { value: "12px" },
  lg: { value: "16px" },
...
var radixColors = __toESM(require("@radix-ui/colors"));
...
var defineColorPalettes = (options) => {
  ...
  return Object.fromEntries(
    [...Object.keys(radixColors), "neutral"].filter((color) => !/[A-Z]/.test(color)).filter((color) => color !== "default").filter((color) => additionalColors.includes("*") || availableColors.includes(color)).map(
      (color) => (0, import_ts_pattern2.match)(color).with("gray", () => [
        color,
...
var defineColorPalette = (color) => {
  ...
  return import_dev62.defineTokens.colors(
...
var defineColorTokens = (options) => {
  ...
  return import_dev63.defineTokens.colors({
...
var durations = import_dev64.defineTokens.durations({
  fastest: { value: "50ms" },
  faster: { value: "100ms" },
  fast: { value: "150ms" },
  normal: { value: "200ms" },
...
var easings = import_dev65.defineTokens.easings({
...
var radii = import_dev66.defineTokens.radii({
  none: { value: "0" },
  "2xs": { value: "0.0625rem" },
  xs: { value: "0.125rem" },
  sm: { value: "0.25rem" },
...
var spacing = import_dev67.defineTokens.spacing({
  0: { value: "0rem" },
  0.5: { value: "0.125rem" },
  1: { value: "0.25rem" },
  1.5: { value: "0.375rem" },
...
var fontSizes = import_dev68.defineTokens.fontSizes({
  "2xs": { value: "0.5rem" },
  xs: { value: "0.75rem" },
  sm: { value: "0.875rem" },
  md: { value: "1rem" },
...
var fontWeights = import_dev68.defineTokens.fontWeights({
  thin: { value: "100" },
...
var letterSpacings = import_dev68.defineTokens.letterSpacings({
...
var lineHeights = import_dev68.defineTokens.lineHeights({
  none: { value: "1" },
  tight: { value: "1.25" },
  normal: { value: "1.5" },
  relaxed: { value: "1.75" },
...
var fonts = import_dev68.defineTokens.fonts({
  sans: {
    value: [
      "ui-sans-serif",
      "system-ui",
...
var zIndex = import_dev69.defineTokens.zIndex({
  hide: {
    value: -1
  },
  base: {
...
var createTokens = (options) => {
  return (0, import_dev70.defineTokens)({
    animations,
    blurs,
    borders,
...
var createPreset = (options = defaultOptions) => {
  ...
  return (0, import_dev71.definePreset)({
